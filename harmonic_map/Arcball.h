...
class Arcball {
    ...
    // if the camera matrix or inv_camera (view matrix) changed, the `updated`
    // will be set to true.
    bool m_updated;
public:
     ...
     */
    Arcball(const glm::vec3& eye, const glm::vec3& center, const glm::vec3& up);

    void set_eye(const glm::vec3& eye, const glm::vec3& center, const glm::vec3& up);
